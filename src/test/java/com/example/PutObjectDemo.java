...
public class PutObjectDemo {
    private static String secretId = "AKIDToyvdhZCcoobBY6f8TdrM1nmODvos39N";
    private static String secretKey = "aFvigswvpZ6Qo9NqHc5omz9688HSckqz";
    private static String bucketName = "test-1300544529";
    ...
    private static void putLocalFileDemo() {
        String key = "logo/logo.png";
        String localPath = "C:\\Users\\Administrator\\Desktop\\logo.png";
